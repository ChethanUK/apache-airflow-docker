...
from k8s.backcompat.kubernetes import kube_client, pod_generator, pod_launcher
from k8s.backcompat.kubernetes.pod_generator import PodGenerator
from k8s.backcompat.kubernetes.secret import Secret
from airflow.models import BaseOperator
from k8s.backcompat.backwards_compat_converters import (
    convert_affinity,
    convert_configmap,
    convert_env_vars,
...
from k8s.backcompat.pod_runtime_info_env import PodRuntimeInfoEnv
